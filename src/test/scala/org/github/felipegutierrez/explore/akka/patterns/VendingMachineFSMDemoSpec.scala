...
class VendingMachineFSMDemoSpec
  extends TestKit(ActorSystem("VendingMachineFSMDemoSpec", ConfigFactory.load().getConfig("interceptingLogMessages")))
    with ImplicitSender
  ...
  import VendingMachineFSMDemo._
